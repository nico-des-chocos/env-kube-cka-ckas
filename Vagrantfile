...
Vagrant.configure("2") do |config|
  ...
  # config.vm.box = "cloud-image/centos-10-stream"
  # config.vm.box_version = "20251124.0"
  ...
  config.vm.provider "virtualbox" do |vb|
    ...
    # Activate the VirtualBox DNS service:
  ...
  config.vm.define "master", primary: true  do |machine|
        ...
        # administration port of klubectl
        ...
        machine.vm.synced_folder "./data/master", "/data"
  end
  ...
  config.vm.define "worker" do |machine|
    ...
    # the path on the guest to mount the folder. And the optional third
    # argument is a set of non-required options.
    machine.vm.synced_folder "./data/worker", "/data"
...
# Provider-specific configuration so you can fine-tune various
  config.vm.define "controller" do |machine|
        ...
        machine.vm.provision "ansible_local" do |ansible|
            ...
            ansible.galaxy_role_file = "ansible/master/requirements.yml"
        ...
        machine.vm.provision "ansible_local" do |ansible|
            ...
            ansible.galaxy_role_file = "ansible/worker/requirements.yml"
            ansible.install = true
            ansible.verbose = true
        end
  end
